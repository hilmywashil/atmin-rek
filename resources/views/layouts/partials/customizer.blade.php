                ...
                <div class="settings-group">
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-control">
                            <div class="color-palette preset-color">
                                <button class="color-swatch-small active" data-bs-toggle="tooltip" title="Ocean Blue"
                                    data-value="preset-1">
                                ...
                                <button class="color-swatch-small" data-bs-toggle="tooltip" title="Rose Pink"
                                    data-value="preset-3">
                                ...
                                <button class="color-swatch-small" data-bs-toggle="tooltip" title="Aqua Cyan"
                                    data-value="preset-8">
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-control">
                            <div class="color-palette header-color">
                                <button class="color-swatch-small" data-bs-toggle="tooltip" title="Ocean Blue"
                                    data-value="preset-1">
                                    <span class="color-preview-small" style="background: #4680ff;"></span>
                                    <i class="ph ph-check color-check"></i>
                                </button>
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-control">
                            ...
                            <button class="reset-color-btn" data-target="logo-color" data-bs-toggle="tooltip"
                                title="Reset to default">
                                <i class="ph ph-arrow-clockwise"></i>
                                <span>Reset to Default</span>
                            </button>
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-control">
                            <div class="icon-selector drp-menu-icon">
                                ...
                                <button class="icon-option" data-value="preset-3" data-bs-toggle="tooltip"
                                    title="Caret Right">
                                    <i class="ti ti-caret-right"></i>
                                </button>
                                <button class="icon-option" data-value="preset-4" data-bs-toggle="tooltip"
                                    title="Plus Circle">
                    ...
                    <div class="setting-item">
                        ...
                        <div class="setting-control">
                            <div class="icon-selector drp-menu-link-icon">
                                ...
                                <button class="icon-option" data-value="preset-5" data-bs-toggle="tooltip"
                                    title="Corner Down">
