                                ...
                                <div class="card-body p-3 rounded"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0">$2,499.00 payment received for Pro Plan subscription
                                                from Acme Corp</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3 rounded"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-2">New login detected from San Francisco, CA. If this
                                                wasn't you, please secure your account</p>
                                ...
                                <div class="card-body p-3 rounded"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0">New AI-powered insights are now available in your
                                                dashboard. Check out the enhanced analytics</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img class="img-radius avatar rounded-0"
                                                src="/assets/images/user/avatar-5.svg"
